...
<script type="text/javascript">
  ...
  {
       swal({
  title: "There are no similar search results",
  text: "Please try other keywords to find similar courses!",
  type: "warning",
...
require('../DB/DB.php');
     ...
     $db = new DB(); 
     $result =$db->getAllCourseWithTeacherActFinSearch($textSearch);
