...
<div class="bg-white text-center  innerAll border-bottom">
    ...
    padding: 0 10px;
    display: block;
    border: none; "   > Assignment Grading </button>
				</form> 
		</li>
...
<h1 class="bg-white content-heading border-bottom text-primary center ">Assignment Grading</h1>
</div>
  		...
  		foreach ($result2 as $item2) 
{
	$assigmentmark =  $item2['mark'] ;
 		 ...
 		 ?> 
                ...
                <div class="media-body">
					...
					<h3 class="text-primary"><?php echo $item['firstName']. " " .$item['lastName']; ?></h3><br>	Total mark : <?php echo $assigmentmark; ?>
					<br>				
					<h4 class="text-primary" id="markH"> Student  mark:  <?php echo $item['mark']; ?></h4>
                    <div class="clearfix"></div>
					<small>Submitted in : <?php echo $item['DateAdded']; ?></small> <small><i class="fa fa-fw icon-calendar-2"></i><?php echo " On : " . $item['timeAdded']; ?><i class="icon-time-clock fw"></i></small>
					<div class="clearfix"></div>
					...
					<div class="innerAll   " >
						<div class="media inline-block margin-none">
							<div class="innerLR bg-gray border-left">
								...
								<div class="media-body">
									<div  ><a target="_blank" href="<?php echo $item['solutionFile']; ?>" class=" text-regular" download>solution File </a></div>
  ...
  <?php 
	...
	<div class="pull-right">
		<a href="" class="btn btn-success btn-xs btn-show-textbox text-center " style="width: 149px; height: 30px; font-weight: bold; font-size:medium;">ADD MARK<i class="fa fa-check"></i> </a>
	</div>
    <div class="pull-right" id="solvedTextbox" style="display: none;">
		...
		<div class="pull-right">
        <button id="saveButton"  onclick="saveChanges()"  class="btn btn-success">Save<i class="fa fa-check"></i></button>
        <button id="closeButton" class="btn btn-danger ">Close<i class="fa fa-times"></i></button>
		</div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var  txt="Are you sure you want to save this mark?";
