...
<div class="row">
                	<?php
$no = 1;
	$result =$db->getaStudentassigmentEvaluation($assigmentevId);
        ...
        <ul class="media-list">
            <li class="media">
                ...
                <div class="media-body">
					<h4 class="text-primary"><?php echo $item['firstName'].$item['lastName']; ?></h4>
					<h5 class="text-primary" id="markH"> mark:  <?php echo $item['mark']; ?></h5>
