	...
	<div class="sidebar sidebar-inverse">
		...
		<div class="sidebarMenuWrapper">
			<ul class="list-unstyled">
				...
				<li class="active2"><a href="teacher_profile.php"><i class="icon-user-1"></i><span>Teacher Profile</span></a></li>
				<li class="active3"><a href="classroom.php"><i class="glyphicon glyphicon-book"></i><span> current Courses</span></a></li>

				<li class="active4"><a href="Finishedclassroom.php"><i class="glyphicon glyphicon-file"></i><span>  Finished  Courses</span></a></li>
