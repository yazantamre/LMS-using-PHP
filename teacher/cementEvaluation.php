		...
		foreach ($result as $item) 
{
			...
			<span class="media">
				<span class="media-body">
					...
					<br>
					  ...
					  <form class="form-horizontal" action="assigment_evaluation.php" method="POST" enctype="multipart/form-data">
    <div class="text-right" style="margin-top: -10px; margin-right: 10px;">
        ...
        <input type="text" name="courseId" value="<?php echo $courseId; ?>" hidden readonly/>
        <button type="submit" name="submit" class="btn btn-primary btn-xs" style="width: 100px; height: 30px; font-weight: bold; font-size: medium;">
