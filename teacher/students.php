...
?> 
					<form    action="students_marks.php" method="POST" enctype="multipart/form-data"  class="list-group-item ">
					<span class="media">
						<img style="object-fit:cover!important; width:50px;height:50px;" src="<?php echo $item['imagePath']; ?>" alt="" width="35" class="thumb img-responsive img-circle pull-left" />
						...
						<span class="media-body">
							...
							<div class="pull-right">
							 <button id="userButton" title="Show student's grades" type="submit" name ="submit"  class="btn btn-circle btn-info"  ><i class="fa fa-fw fa-user" ></i></button>
							 </div>
