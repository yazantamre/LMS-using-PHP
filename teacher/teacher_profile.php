                        ...
                        <div class="col-sm-12 col-md-2" style="margin-left: 10px; ">
                            ...
                            <div class="tab-pane" id="productPhotosTab">
                                ...
                                <div style="margin-top: 10px;">
                                    ...
                                    <input style="width: 82px !important; height: auto" type="submit" id="submit" name="submit1" class="btn btn-primary" value="Save">
                                </div>
...
var myNewURL = "Online Lms/teacher/teacher_profile.php";
 if (res == 1   ) {
