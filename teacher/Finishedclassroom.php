...
$userid =  $_SESSION['id'];
  ?>
<head>
	<title>My finished courses</title>
...
<body>
	...
	<div id="content"><h1 class="content-heading bg-white border-bottom text-primary">Finished Courses</h1>
...
$result =$db->getTeacherCourse($userid,3,1);
...
<input type="text"  name="courseId" value="<?php echo $item['id']; ?>" hidden readonly>
		<div class="course" id="course1">
			...
			<h2 style=""><?php echo $item['name']   ; ?> </h2>
...
<?php } ?>
		...
		<!-- Course 2 -->
			...
			<!-- أضف الرموز الأخرى التي تحتاجها هنا -->	
