...
<div class="innerAll pull-left" style="margin-left: 60px;">
...
<td class="bg-gray center" >Late</td>
  ...
  <td class="bg-primary center">Missing</td>
                  ...
                  <form class="form-horizontal" action="Finishedsolution.php" method="POST" enctype="multipart/form-data">
