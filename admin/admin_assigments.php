...
<a style="margin-left: 20px; pointer-events: none;" href="" class="strong" style="margin-left: 10px;"><?php echo $item['firstName']. " ".$item['lastName']  ; ?></a><br>
<small><i style="margin-left: 20px;" style="margin-left: 20px;" class="fa fa-fw icon-calendar-2"></i><?php echo $item['DateAdded']   ; ?> </small>
...
<span class="media">
	...
	<span class="media-body">
		<h4 class=" strong"><?php echo $item2['firstName'] .$item2['lastName']   ; ?> <i class="icon-flag text-primary icon-2x"></i>  <br><small><i class="fa fa-fw icon-calendar-2"></i><?php echo $item2['DateAdded']   ; ?></small></h4>
...
function toggleComments2() {
    ...
    var container2 = document.querySelector(".comments-container2");
    
    if (comments2.style.visibility === "hidden") {
        comments2.style.visibility = "visible"; // إذا كانت مخفية، قم بإظهارها
        container2.style.display = "block"; // إذا كانت مخفية، قم بإظهار المساحة
    } else {
        comments2.style.visibility = "hidden"; // إذا كانت مرئية، قم بإخفائها
        container2.style.display = "none"; // إذا كانت مرئية، قم بإخفاء المساحة
    }
}
