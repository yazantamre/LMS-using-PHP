...
<body>
    ...
    <div id="content"><h1 class="bg-white content-heading border-bottom text-primary ">Enrollment applications management</h1>
    <br>
        ...
        <table style="width: 90%; border: 3px solid #cb4040; " class="table table-bordered table-condensed table-striped table-primary table-vertical-center">
            <thead>
                ...
                <tr>
                    ...
                    <th class="center">Desired course</th>
     ...
     $result =$db->getcoursesappBystatus(3);
     $No= 0  ;
  ...
  echo " <tr  id='row".$item['id']."'>
                ...
                <td class='center' >  ".$item['DateAdded']." </td>

                  <td class='center'>
                        <div class='btn-group btn-group-sm'>
                            <a title='reject application' href='#' class='btn btn-danger'   id='r".$item['id']."' onclick='runMyFunction(this.id)'><i class='fa fa-times'></i></a>
                            <a title='accept application' href='#' class='btn btn-success' 
                             id='a".$item['id']."' onclick='runMyFunction(this.id)'><i class='fa fa-check'></i></a>
...
{ 
 ...
 var appid =id.substring(1);
 var appStatustxt = id.charAt(0);
 var appStatus = "";
  var txtStatus = " ";
  var rowid = "row"+appid;
 ...
 if (appStatustxt=='a') 
    ...
    txtStatus= "Are you sure you want to accept this application?"; }
else
    {
    appStatus = 2 ; 

    txtStatus= "Are you sure you want to reject this application?";
     }
  ...
  var xmlhttp = new XMLHttpRequest();
   ...
   var row = document.getElementById(rowid);
    row.parentNode.removeChild(row);
        ...
        xmlhttp.open("GET", "../DB/togglecoursesappStatus.php?appid=" + appid +" && appStatus=" + appStatus, true);
        xmlhttp.send();
});
