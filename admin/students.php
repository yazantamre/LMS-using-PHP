...
.confStatus {color: rgb(248 148 54)!important; } 
...
<body>
    ...
    <div id="content"><h1 class="bg-white content-heading border-bottom text-primary ">Students management</h1>
    <br>
...
if ($status == 1) {
    echo " <tr>
                ...
                <td class='center'>
                    <div class='btn-group btn-group-sm'>
                        <button type='button' title='Toggle student status' href='#'   id='a" . $item['id'] . "'   class='btn btn-danger'onclick='runMyFunction(this.id)'>
    ...
    echo " <tr>
                ...
                <td class='center'>
                    <div class='btn-group btn-group-sm'>
                        <button type='button' title='Toggle student status'  class='btn btn-success'   id='i" . $item['id'] . "' onclick='runMyFunction(this.id)'>Toggle Status</button>
                    </div>
                </td>
            </tr>";
}
...
{ 
 ...
 if (userStatus=='a') 
    ...
    txtStatus= "Inactive";
       msgTxt = 'Are you sure you want to Deactivate this students account?' ; }
else
    {
    userStatus = 1 ; 

    txtStatus= "Active";
    msgTxt = 'Are you sure you want to Activate this students account?' ; }
